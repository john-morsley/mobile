...
public class CosmosDbMobileReceivedPersistenceService : CosmosDbMobilePersistenceService, IReceivedSmsPersistenceService
{
    ...
    public CosmosDbMobileReceivedPersistenceService(
        ...
        ILogger<CosmosDbMobileReceivedPersistenceService> logger) : base(cosmosClient, options.DatabaseName, options.ReceivedSmsContainerName)
    {
        _logger = logger;
    }    
